...
Route::middleware(['auth:sanctum', 'force-password-change'])->group(function () {
    ...
    Route::middleware('admin')->prefix('admin')->group(function () {
        ...
        Route::prefix('database')->group(function () {
            Route::get('/info', [\App\Http\Controllers\Api\DatabaseBackupController::class, 'info']);
            Route::get('/backups', [\App\Http\Controllers\Api\DatabaseBackupController::class, 'index']);
            Route::post('/backup', [\App\Http\Controllers\Api\DatabaseBackupController::class, 'backup']);
            Route::post('/restore/{file}', [\App\Http\Controllers\Api\DatabaseBackupController::class, 'restore']);
            Route::delete('/delete/{file}', [\App\Http\Controllers\Api\DatabaseBackupController::class, 'delete']);
            Route::get('/download/{file}', [\App\Http\Controllers\Api\DatabaseBackupController::class, 'download']);
            Route::post('/optimize', [\App\Http\Controllers\Api\DatabaseBackupController::class, 'optimize']);
        });
